...
3. Trains a PyTorch resnet-34 model which was pretrained on ImageNet using two methods: first, by freezing all but the last layers and second, by fine-tuning of the whole network.
